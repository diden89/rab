...
CREATE TABLE `log_material_consumption`  (
  ...
  `mc_quantity` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `mc_total` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `mc_date_order` datetime(0) NULL DEFAULT NULL,
  `mc_is_active` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT 'Y',
  `last_user` int(11) NULL DEFAULT NULL,
  `last_datetime` datetime(0) NULL DEFAULT NULL,
  `log_user_id` int(10) UNSIGNED NOT NULL,
  `log_action` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `log_material_consumption` VALUES (1, 8, 3, 250000.00, '2', '22', '2020-10-31 20:02:30', 'Y', 1, '2020-10-31 20:02:34', 0, '', '0000-00-00 00:00:00', 2);
INSERT INTO `log_material_consumption` VALUES (2, 8, NULL, 300.00, '5240', '1572000', '2020-11-02 00:00:00', 'Y', 1, '2020-11-02 23:59:44', 1, 'add', '2020-11-02 23:59:44', 3);
INSERT INTO `log_material_consumption` VALUES (3, 12, NULL, 232.00, '23232', '5389824', '2020-11-03 00:00:00', 'Y', 1, '2020-11-03 00:05:06', 1, 'add', '2020-11-03 00:05:06', 4);
INSERT INTO `log_material_consumption` VALUES (4, 8, 3, 2312.00, '3213', '7428456', '2020-11-03 00:00:00', 'Y', 1, '2020-11-03 00:07:44', 1, 'add', '2020-11-03 00:07:44', 5);
INSERT INTO `log_material_consumption` VALUES (5, 9, 3, 1.00, '234', '234', '2020-11-03 00:00:00', 'Y', 1, '2020-11-03 00:18:13', 1, 'add', '2020-11-03 00:18:13', 6);
