function show_ruangan_kelas(id)
{
    $.ajax({
        url: siteUrl+'data_laporan_absen_siswa/get_select_ruangan',
        data: {'id_kelas' : id},            
        // dataType: "json",
        type: "POST",
        success: function (data) {
            $('#reloadTableDataKelasRuangan').html(data);                
        }
    });

}

function show_data_absen_siswa(id)
{
    $.ajax({
        url: siteUrl+'data_laporan_absen_siswa/load_report_absen_siswa',
        data: {'ruangan_id' : id},            
        // dataType: "json",
        type: "POST",
        success: function (data) {
            $('.reloadTableDataRekapAbsen').html(data);                
        }
    });
...
$(document).ready(function() {
    ...
    var id_jurusan = $('#TxtJurusan').val();
        $.ajax({
            url: siteUrl+'data_laporan_absen_siswa/get_select_kelas',
            data: {'id_jurusan' : id_jurusan},            
            // dataType: "json",
            type: "POST",
            success: function (data) {
                $('#reloadTableDataKelas').html(data);
