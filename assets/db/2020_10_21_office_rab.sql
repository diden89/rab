...
CREATE TABLE `menu`  (
  ...
  `m_parent_id` int NULL DEFAULT NULL,
  `m_caption` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `m_url` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `m_description` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `m_seq` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `m_is_active` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'Y',
  `m_icon` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (13, NULL, 'Pages', 'configuration', 'adasdas', NULL, 'N', 'fa fa-check-circle');
INSERT INTO `menu` VALUES (14, 13, 'Services', 'services', NULL, NULL, 'N', 'fa fa-cog');
INSERT INTO `menu` VALUES (17, 13, 'Header', 'slide', '', NULL, 'N', 'fa fa-picture-o');
INSERT INTO `menu` VALUES (18, NULL, 'Settings', 'settings', 'asdasdsa', NULL, 'Y', 'fa fa-wrench');
INSERT INTO `menu` VALUES (19, 18, 'Karyawan', 'employee', '', NULL, 'N', 'fa fa-users');
INSERT INTO `menu` VALUES (20, 18, 'Pengguna', 'users', '', NULL, 'N', 'fa fa-key');
INSERT INTO `menu` VALUES (21, 18, 'Company', 'company', 'asdasdas', NULL, 'Y', 'fa fa-building');
INSERT INTO `menu` VALUES (22, 18, 'Category', 'category', '', NULL, 'N', 'fa fa-navicon');
INSERT INTO `menu` VALUES (23, 18, 'Master Menu', '', 'asdasdasd', NULL, 'Y', 'fa fa-picture-o');
INSERT INTO `menu` VALUES (40, NULL, 'Master', '', '', NULL, 'N', 'fa fa-cog');
INSERT INTO `menu` VALUES (60, 40, 'Data Jurusan', 'data_jurusan', '', NULL, 'N', 'fa fa-chevron-right');
INSERT INTO `menu` VALUES (61, 40, 'Data Kelas', 'data_kelas', '', NULL, 'N', 'fa fa-university');
INSERT INTO `menu` VALUES (62, 40, 'Data Siswa', 'data_siswa', '', NULL, 'N', 'fa fa-group');
INSERT INTO `menu` VALUES (63, 40, 'Data Mata Pelajaran', 'data_mapel', '', NULL, 'N', 'fa fa-book');
INSERT INTO `menu` VALUES (64, 40, 'Data Guru', 'data_guru', '', NULL, 'N', 'fa fa-users');
INSERT INTO `menu` VALUES (65, 40, 'Data Ruangan', 'data_ruangan', '', NULL, 'N', 'fa fa-university');
INSERT INTO `menu` VALUES (66, 67, 'Data Kelas Mengajar', 'data_ajar', '', NULL, 'N', 'fa fa-book');
INSERT INTO `menu` VALUES (67, NULL, 'Mengajar', '', '', NULL, 'N', 'fa fa-university');
INSERT INTO `menu` VALUES (68, 67, 'Data Siswa Ajar', 'data_ajar_siswa', '', NULL, 'N', 'fa fa-users');
INSERT INTO `menu` VALUES (69, NULL, 'Absen', '', '', NULL, 'N', 'fa fa-hand-paper-o');
INSERT INTO `menu` VALUES (70, 69, 'Absen Siswa', 'data_absen_siswa', '', NULL, 'Y', 'fa fa-user-plus');
INSERT INTO `menu` VALUES (71, 69, 'Laporan Absen Siswa', 'data_laporan_absen_siswa', '', NULL, 'N', 'fa fa-sticky-note-o');
INSERT INTO `menu` VALUES (72, 18, 'Data Modem', 'data_modem', '', NULL, 'N', 'fa fa-signal');
INSERT INTO `menu` VALUES (74, 23, 'Menu', 'settings/menu', 'asdasd', NULL, 'Y', 'fa fa-list');
